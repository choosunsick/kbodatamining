...
pitcher_id  <- read.csv("./player_id_list/pitcher_id_full.csv",stringsAsFactors = F)
...
id_2018<- pitcher_id[substr(pitcher_id$date,1,4)==2018,]
id_hanhwa_2018<- id_2018[id_2018$away=="한화"|id_2018$home=="한화",]
hanhwa_pitcher_2018 <- get_player_id(hanhwa_pitcher_2018,id_hanhwa_2018)
