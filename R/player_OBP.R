...
#' @return The On-base percentage for the year, month, or period put in is calculated.
#' @examples
#' ## default
#' player_OBP(hanhwa_batter_2018,"이용규")
#' ## yearly=2018, monthly=NULL
#' player_OBP(hanhwa_batter_2018,"이용규",yearly=2018)
#' ## yearly=NULL, monthly="05"
#' player_OBP(hanhwa_batter_2018,"이용규",monthly="05")
#' ## yearly=2018, monthly="05"
#' player_OBP(hanhwa_batter_2018,"이용규",yearly=2018,monthly="05")
#' @export

player_OBP <- function(data=kbodatamining::hanhwa_batter_2018,playername,yearly=NULL,monthly=NULL){
  obp <- date_test(data,playername,yearly,monthly,obp_formula)
  return(obp)
}
