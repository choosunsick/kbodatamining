#' Calculating batter's Ground into double play
#'
#' This function calculates the Ground into double play for the specified player.
#' This function has an option for yearly and monthly.
#' default: the annualy Hit by pitch is calculated
#' If you put a year in the yearly parameter, it calculates the corresponding year Ground into double play.
#' If you put a month in the monthly parameter, it calculates the corresponding yearly-month Ground into double play.
#' If you put a year and a month in two parameters, the Ground into double play for the specific time you put in is calculated.
