...
#' If you put a year in the yearly parameter, it calculates the corresponding year Triples.
#' If you put a month in the monthly parameter, it calculates the corresponding yearly-month Triples.
#' If you put a year and a month in two parameters, the Triples for the specific time you put in is calculated.
...
#' @return The Triples for the year, month, or period put in is calculated.
#' @examples
#' ## default
...
#' player_3B(hanhwa_batter_2018,"이용규",monthly="05")
#' ## yearly=2018, monthly="05"
#' player_3B(hanhwa_batter_2018,"이용규",yearly=2018,monthly="05")
#' @export

player_3B <- function(data=kbodatamining::hanhwa_batter_2018,playername,yearly=NULL,monthly=NULL){
  three_B <- date_test(data,playername,yearly,monthly,threebase_formula)
  return(three_B)
}
