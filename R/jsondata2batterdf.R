...
#' ## you can open it and use it as an paremeter of the function.
#' ## The gameid paremeter can be obtained through using the default function names.
#'
#' @param jsondata KBO data json file
#' @param gameid KBO game date and versus infomation
#' @return the batter dataframe data that is changed from json data file
#' @examples
#' ## not run
