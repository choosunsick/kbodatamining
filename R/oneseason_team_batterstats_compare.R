#' Comparing batting stats of two teams during one season
#'
...
#' compare_batter_statistic_teams(hanhwa_batter_2018,"한화","LG",yearly=2018,monthly=NULL)
#' ## yearly=2018, monthly="05"
#' compare_batter_statistic_teams(hanhwa_batter_2018,"한화","LG",yearly=2018,monthly="05")
#' @export

compare_batter_statistic_teams <- function(data,team1,team2,yearly=2018,monthly=NULL){
  team1 <- team_batter_boxscore(data = data,teamname = team1,yearly = yearly,monthly = monthly)
  team2 <- team_batter_boxscore(data = data,teamname = team2,yearly = yearly,monthly = monthly)
